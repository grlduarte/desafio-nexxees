...
from formatters import alfa, data, hora


fheader_dict = {'controle': {
                             'banco': ((0, 3), int),
                             'lote': ((3, 7), int),
                             'registro': ((7, 8), int)
                             },
                'empresa': {
                            ...
                            'numero_inscricao': ((18, 32), int),
                            'convenio': ((32, 52), alfa),
                            'cc_agencia': ((52, 57), int),
...
lheader_dict = {
                'controle': fheader_dict['controle'],
                'servico': {
                            'operacao': ((8, 9), alfa),
                            'servico': ((9, 11), int),
...
detail_dict = {'controle': fheader_dict['controle'],
               'servico': {
               ...
               'credito': {
                           ...
                           'qtde_moeda': ((104, 119), int),
                           'valor_pgto': ((119, 134), int),
                           'nosso_numero': ((134, 154), alfa),
                           'data_real': ((154, 162), data),
                           'valor_real': ((162, 177), int),
                           },
